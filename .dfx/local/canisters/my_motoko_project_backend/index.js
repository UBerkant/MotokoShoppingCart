...
import { idlFactory } from './my_motoko_project_backend.did.js';
export { idlFactory } from './my_motoko_project_backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_MY_MOTOKO_PROJECT_BACKEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./my_motoko_project_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the my_motoko_project_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./my_motoko_project_backend.did.js")._SERVICE>}
 */
export const my_motoko_project_backend = createActor(canisterId);
