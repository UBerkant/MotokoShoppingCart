...
import { idlFactory } from './my_motoko_project_frontend.did.js';
export { idlFactory } from './my_motoko_project_frontend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_MY_MOTOKO_PROJECT_FRONTEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./my_motoko_project_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the my_motoko_project_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./my_motoko_project_frontend.did.js")._SERVICE>}
 */
export const my_motoko_project_frontend = createActor(canisterId);
