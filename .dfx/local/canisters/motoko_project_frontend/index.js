...
export const canisterId = process.env.CANISTER_ID_MOTOKO_PROJECT_FRONTEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./motoko_project_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the motoko_project_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./motoko_project_frontend.did.js")._SERVICE>}
 */
export const motoko_project_frontend = createActor(canisterId);
